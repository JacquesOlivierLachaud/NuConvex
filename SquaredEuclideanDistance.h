...
namespace DGtal
{
  ...
  struct SquaredEuclideanDistance
    : public std::binary_function< TRealPoint, TRealPoint,
                                   typename TRealPoint::Coordinate >
  {
    // ----------------------- Standard services ------------------------------
  public:
    ...
    typedef std::binary_function< RealPoint, RealPoint, Coordinate > Base;
...
#include "SquaredEuclideanDistance.ih"
